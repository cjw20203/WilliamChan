...
[task_local]
#京东神仙书院
0 8 * * * https://qxzy.top/rules/QuantumultX/js/jd_immortal.js, tag=京东神仙书院, enabled=true

================Loon==============
[Script]
cron "0 8 * * *" script-path=https://qxzy.top/rules/QuantumultX/js/jd_immortal.js,tag=京东神仙书院

===============Surge=================
京东神仙书院 = type=cron,cronexp="0 8 * * *",wake-system=1,timeout=2000,script-path=https://qxzy.top/rules/QuantumultX/js/jd_immortal.js

============小火箭=========
京东神仙书院 = type=cron,script-path=hhttps://qxzy.top/rules/QuantumultX/js/jd_immortal.js, cronexpr="0 8 * * *", timeout=2000, enable=true
 */
...
const inviteCodes = [
  '43xIs4YwE5Z7DsWOzDSFaFTWfI8wjtBTK6oKtBRL3dssTUcZB9wkcA3D1gSn4kmtyBxg@ 43xIs4YwE5Z7HtcfJGrHssiDnKZ41J3dy065-3KUmgHWYUL8ISw0ZShjbF5A7EnHL6Pw',
];
!(async () => {
  await requireConfig();
  if (!cookiesArr[0]) {
